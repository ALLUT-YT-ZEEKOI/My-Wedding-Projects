...
class User extends Authenticatable
{
    ...
    public function vendorSubscriptions() { return $this->hasMany(VendorSubscription::class, 'vendor_id'); }
    public function halls() { return $this->hasMany(Hall::class, 'vendor_id'); }
